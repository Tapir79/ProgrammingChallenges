...
public class Problem11LeapYear {

    public static void main(String[] args) {

        int[] years = {1600, 1604, 1608, 1612, 1616, 1620, 1624, 1628, 1632, 1636, 1640, 1644,
                1648, 1652, 1656, 1660, 1664, 1668, 1672, 1676, 1680, 1684, 1688, 1692, 1696, 1704,
    ...
    private static boolean isALeapYear(int year) {
        // id divisible by 4 and 100 but not 400
        if (year % 4 == 0 && year % 100 == 0 && year % 400 != 0) {
            // System.out.println("Not a leap year");
            return false;
        }
        // is divisible by 4,100 and 400
